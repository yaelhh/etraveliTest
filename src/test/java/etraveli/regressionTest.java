...
public class regressionTest {
    ...
    void AllFlight() {
        System.out.println(
                "----In this test, we will validate the stopovers filter with the 'All flights' option selected.----");
        firstPage.firstSearch();
        filterScales filterScalesPage = new filterScales(page);
    ...
    void SelfTransferFilter() {
        // I understand that "Show flights without self-transfer" is the same as direct
        // flights, meaning no stopovers.
        // This test fails because the button does not apply this filter — maybe the
        // button is intended to do something else, and I might need more information.
